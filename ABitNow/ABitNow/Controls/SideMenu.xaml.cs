...
namespace ABitNow.Controls
{
    public partial class SideMenu : ContentView
    {
        public static readonly BindableProperty UserInfoProperty = BindableProperty.Create(nameof(UserInfo), typeof(User), typeof(SideMenu), null, BindingMode.TwoWay, propertyChanged: (bindable, oldValue, newValue) =>
        {
